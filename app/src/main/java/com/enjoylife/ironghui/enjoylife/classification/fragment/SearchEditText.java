...
public class SearchEditText extends EditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mSearchDrawable == null) {
            mSearchDrawable = getResources().getDrawable(android.R.drawable.ic_menu_search);
        }
        // 获取EditText的DrawableRight,假如没有设置我们就使用默认的图片,获取图片的顺序是左上右下（0,1,2,3,）
    ...
    protected void setClearIconVisible(boolean visible) {
        Drawable left = visible ? null : mSearchDrawable;
